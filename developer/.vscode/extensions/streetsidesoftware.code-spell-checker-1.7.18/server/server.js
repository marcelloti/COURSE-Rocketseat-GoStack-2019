...
const defaultSettings = Object.assign({}, CSpell.mergeSettings(cspell_lib_2.getDefaultSettings(), CSpell.getGlobalSettings()), { checkLimit: defaultCheckLimit, enabled: false });
